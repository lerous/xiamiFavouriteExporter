...
if __name__ == "__main__":
	...
	mag = getContent('http://www.xiami.com/space/lib-song/u/'+str(user_id))
	...
	for i in range(cra_num):
		...
		pug = getContent('http://www.xiami.com/space/lib-song/u/'+str(user_id)+'/page/'+ str(i+1))
		createList(pug)
		if i == cra_num-1:
			g = open('xiami.klg','a')	
			g.write('</List>')
			g.close()
			line_prepender('xiami.klg', '<?xml version="1.0" encoding="windows-1252"?>\n<List ListName="虾米音乐">')
			print 'compelete!'
